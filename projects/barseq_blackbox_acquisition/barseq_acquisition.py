...
SUBJECTS = {
    "780345": {
        ...
        # BARseq LC section IDs from aind-data-schema PR #1763 (procedures_sectioning.py).
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate BARseq acquisition metadata JSON files.")
    ...
    for subject_id in SUBJECTS:
        ...
        deserialized.write_standard_file(prefix=f"barseq_{subject_id}", output_directory=output_dir)
